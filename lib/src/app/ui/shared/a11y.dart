...
///
/// Both heading properties are intentional. Flutter 3.47 maps
/// `headingLevel > 0` to the iOS and Android heading APIs, while the legacy
/// `header` flag remains part of Flutter's common accessibility bridge for
/// macOS.
